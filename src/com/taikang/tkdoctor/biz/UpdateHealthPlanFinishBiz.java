...
public class UpdateHealthPlanFinishBiz {
	...
	public void updateUserInfo(String doplanid,String status) {
		Map<String, String> paramsMap = new HashMap<String, String>();
		paramsMap.put("doplanid", doplanid);
		paramsMap.put("status", status);
		NetUtil.httpPostCommon(ServerConfig.URL_PATH_UPDATE_HEALTHOPLAN, paramsMap, "updateHealthPlan", new RequestCallback() {
