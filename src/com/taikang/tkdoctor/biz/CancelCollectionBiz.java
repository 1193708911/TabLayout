...
public class CancelCollectionBiz {
	...
	public void cancelCollection(String informationid) {
		Map<String, String> paramsMap = new HashMap<String, String>();
		paramsMap.put("informationid", informationid);
		NetUtil.httpPostCommon(ServerConfig.URL_PATH_INFO, paramsMap, "deleteCollectMessage", new RequestCallback() {
