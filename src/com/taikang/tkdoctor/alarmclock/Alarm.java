...
public class Alarm implements Serializable{//取消闹方式	
	
	//表中的列名
	public  int _id;//自增长id
	private String alarm_id;//plan_id 健康计划ID
	public  String alarm_time;
	public  String alarm_days;
	public  String alarm_voice;
	...
	public static class Columns implements BaseColumns{
		...
		public static final String[] ALARM_QUERY_COLUMNS = {
            ...
            LABEL,ENABLED,NEXTMILLIS,CONTENT}; 
