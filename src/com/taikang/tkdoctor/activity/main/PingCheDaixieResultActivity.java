...
public class PingCheDaixieResultActivity extends BaseActivity implements NetCallback{
	...
	private void postData(HashMap<String, String> parmMap) {
		...
		daiXieBiz.getDaiXie(sex, height, age, birthday, parmMap);
	}
	...
	public void taskSuccess(Response response) {
		...
		if (listBean != null) {
			...
			String url = ServerConfig.SERVER_PATH + urlBean.getUrl() + ServerConfig.evalNumberId_Daixie;
...
//		infoBean.setReport_type(Constants.METABOLISM);
//		infoBean.setReport_url(url);
		PreferencesUtil.putString("daixie", url);
