...
public class PingCheGaoxueyaResultActivity extends BaseActivity implements NetCallback{
	...
	private void loadData() {
		...
		webView.loadUrl("file:///android_asset/hbp_questions.html");
...
//			params.put("9", "A");
	...
	private void postData(HashMap<String, String> parmMap) {
		...
		gaoXueYaBiz.getGaoXueYa(sex, height, age, birthday, parmMap);
	}
	...
	public void taskSuccess(Response response) {
		...
		if (listBean != null) {
			...
			String url = ServerConfig.SERVER_PATH + urlBean.getUrl() + ServerConfig.evalNumberId_Gaoxueya;
...
//			infoBean.setReport_type(Constants.HIGHT_BLOOD_PRESSURE);
//			infoBean.setReport_url(url);
			PreferencesUtil.putString("gaoxueya", url);
