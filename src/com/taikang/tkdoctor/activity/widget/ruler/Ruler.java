...
//		paramsTop.rightMargin=dp2px(0);
		paramsTop.leftMargin=dp2px(2);//控制标尺字符的位置
...
//		params2.addRule(RelativeLayout.ABOVE, R.id.unit_container_id);
...
//			textUnitView.setTextSize(maxTextSize);
			textUnitView.setTextSize(TypedValue.COMPLEX_UNIT_SP,13);
			if(i<maxUnitCount*2-1){
				textUnitView.setLayoutParams(maxParams);
			}else if(i<maxUnitCount*2){
				LinearLayout.LayoutParams param = new LinearLayout.LayoutParams(dp2px((int) minUnitSize)*4, -2);
				textUnitView.setLayoutParams(param);
			}else{
				LinearLayout.LayoutParams param = new LinearLayout.LayoutParams(dp2px((int) minUnitSize)*3, -2);
				param.leftMargin=10;
				textUnitView.setLayoutParams(param);
			}
			textUnitView.setGravity(Gravity.BOTTOM | Gravity.LEFT);
			if (i % 2 == 0) {
				textUnitView.setText(String.format("%d  ", (i / 2+20)));
			}
...
//		TextView textUnitView = new TextView(getContext());
//		textUnitView.setTextSize(maxTextSize);
//		LinearLayout.LayoutParams lp=new LinearLayout.LayoutParams(android.widget.LinearLayout.LayoutParams.WRAP_CONTENT, -2);
//		textUnitView.setLayoutParams(lp);
//		textUnitView.setGravity(Gravity.BOTTOM | Gravity.LEFT);
//		textUnitView.setText(String.format("%d",maxUnitCount));
//		textContainer.addView(textUnitView);
	}
	...
	public void scrollTo(int max, int min, float val) {
		...
		int scrollx=(int) (((total-200) - minVal + val) * dp2px((int) minUnitSize));
		scrollerView.smoothScrollTo(scrollx, 0);
